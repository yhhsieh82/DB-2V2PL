...
import org.vanilladb.core.storage.tx.concurrency.tpl.TplLockTable;

public class TplLockTableTest {
	private static Logger logger = Logger.getLogger(TplLockTableTest.class
			.getName());
	...
	private static TplLockTable lockTbl;

	@BeforeClass
	public static void init() {
		ServerInit.init(TplLockTableTest.class);
